...
@Module({
  providers: [CanCommonService, CanTextParserService, CanCsvParserService, CanFileService, CanExcelExportService],
  exports: [CanCommonService, CanPermissionModule, CanTextParserService, CanCsvParserService, CanFileService],
